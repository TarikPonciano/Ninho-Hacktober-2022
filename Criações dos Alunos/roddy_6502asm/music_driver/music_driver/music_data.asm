RMD_DATA_BEGIN:         ; MUSIC DATA BEGIN
    ...
    MusicModulesLo: .byte <test_module_new, <module_coolbricks
    MusicModulesHi:
        .byte >test_module_new, >module_coolbricks

    .define total_bgm   .sizeof(MusicModulesLo)
    print .concat("Total BGM Modules: ", .string(total_bgm))
    ...
    print .concat("Total SFX Modules: ", .string(total_sfx))
    ...
    print .concat("Total Instruments: ", .string(total_instruments))
